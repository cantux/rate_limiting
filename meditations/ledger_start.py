...
class Order:
    ...
    def __init__(self, limit_price, num_contracts, type="unknown"):
...
def test():
    ...
    buy_three_for_sixteen = Order("buy", 3, 16)
    buy_three_for_sixteen_but_only_get_two = Order("buy", 3, 16) # -> just fulfill 2 orders for 15 -> leave a remaining order open
